...
/*    Load byte from shortmem to register
**  =======================================
**   |   Name   : shortMem |
...
/*   Load byte from longmem to register
** =======================================
**   |   Name   : LongMem |
...
void test_LD_shortptr_W_0x11_expected_0x11(void){
  uint8_t instrc[]	= {0xc6,0x40};                       // Opcode : 0xc640
	...
	memory[0x41]			= 0xe5;
	memory[0x42e5]		= 0x11;
	ldA_shortptr_w(instrc);                                // store 0x11 into memory location 0x42e5.
