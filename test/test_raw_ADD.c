...
void test_raw_add_given_value_0x00_add_with_0x00_expected_0x00_with_zero_bit_equal_1(void){
  cpuRegisters->A = 0x00;
  raw_add(0x00);
...
void test_raw_add_given_value_0x00_add_with_0x01_expected_0x01_with_all_flag_equal_0(void){
  cpuRegisters->A = 0x00;
  raw_add(0x01);
...
void test_raw_add_given_value_0x81_add_with_0x01_expected_negative_overflow_flag_equal_1(void){
  cpuRegisters->A = 0x81;
  raw_add(0x01);
