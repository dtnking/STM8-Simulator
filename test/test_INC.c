...
void test_INC_longoff_Y_given_value_0x99_expect_0x9a(void){
    set_Y(0x34,0x34);
    uint8_t instrc[]={0x4C,0x29,0x29};
    memory[0x5d5d]  = 0x99;
    inc_longoff_Y((uint8_t *)&instrc);
...
void test_INC_shortptr_w_Y_given_value_0x40_expect_0x41(void){
    ...
    memory[0x8a]  = 0x11;
    memory[0x2922]  = 0x80;
    inc_shortptr_w_Y((uint8_t *)&instrc);
