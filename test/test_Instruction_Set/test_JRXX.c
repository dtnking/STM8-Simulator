...
void test_jrc_given_correct_condition_expected_PC_eq_0x13(void){
  cpuRegisters->CCR.bit.C = 1;
  uint8_t instrc[] = {0x25,0x11};
  jrc(instrc);

  TEST_ASSERT_EQUAL_HEX16(0x13, GET_PC);
}
...
void test_jreq_given_correct_condition_expected_PC_eq_0x14(void){
...
void test_jrh_given_correct_condition_expected_PC_eq_0x17(void){
...
void test_jrm_given_correct_condition_expected_PC_eq_0x18(void){
...
void test_jrmi_given_correct_condition_expected_PC_eq_0x18(void){
...
void test_jrnc_given_correct_condition_expected_PC_eq_0x19(void){
...
void test_jrne_given_correct_condition_expected_PC_eq_0x1a(void){
  uint8_t instrc[] = {0x26,0x18};
  jrne(instrc);

  TEST_ASSERT_EQUAL_HEX16(0x1a, GET_PC);
}
...
void test_jrnh_given_correct_condition_expected_PC_eq_0x1c(void){
...
void test_jrnm_given_correct_condition_expected_PC_eq_0x1c(void){
  uint8_t instrc[] = {0x90,0x28,0x19};
  jrnm(instrc);
...
void test_jrnv_given_correct_condition_expected_PC_eq_0x1d(void){
...
void test_jrpl_given_correct_condition_expected_PC_eq_0x1e(void){
...
void test_jrsge_givencorrect_condition_expected_PC_eq_0x1f(void){
  cpuRegisters->CCR.bit.N = 1;
  cpuRegisters->CCR.bit.V = 1;
...
void test_jrsgt_given_correct_condition_expected_PC_eq_0x20(void){
  cpuRegisters->CCR.bit.N = 1;
  cpuRegisters->CCR.bit.V = 1;
...
void test_jrsle_given_correct_condition_expected_PC_eq_0x21(void){
  cpuRegisters->CCR.bit.N = 1;
  cpuRegisters->CCR.bit.Z = 1;
  uint8_t instrc[] = {0x2D,0x1F};
  jrsle(instrc);

  TEST_ASSERT_EQUAL_HEX16(0x21, GET_PC);
}
...
void test_jrslt_given_correct_condition_expected_PC_eq_0x22(void){
  cpuRegisters->CCR.bit.N = 1;
...
void test_jrt_expected_PC_eq_0x23(void){
  uint8_t instrc[] = {0x20,0x21};
  jrt(instrc);

  TEST_ASSERT_EQUAL_HEX16(0x23, GET_PC);
}

void test_jruge_given_correct_condition_expected_PC_eq_0x24(void){
...
void test_jrugt_given_correct_condition_expected_PC_eq_0x25(void){
...
void test_jrule_given_correct_condition_expected_PC_eq_0x26(void){
  cpuRegisters->CCR.bit.C = 1;
  cpuRegisters->CCR.bit.Z = 1;
  uint8_t instrc[] = {0x23,0x24};
  jrule(instrc);

  TEST_ASSERT_EQUAL_HEX16(0x26, GET_PC);
}
...
void test_jrult_given_correct_condition_expected_PC_eq_0x27(void){
  cpuRegisters->CCR.bit.C = 1;
  uint8_t instrc[] = {0x25,0x25};
  jrult(instrc);

  TEST_ASSERT_EQUAL_HEX16(0x27, GET_PC);
}
...
void test_jrv_given_correct_condition_expected_PC_eq_0x27(void){
  cpuRegisters->CCR.bit.V = 1;
