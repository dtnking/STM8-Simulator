...
void test_AND_shortoff_with_x_given_A_0xab_and_the_value_of_the_address_0x00_expected_0x00(void){
	cpuRegisters->A 	= 0xab;
	set_X(0x12,0x12);
...
void test_AND_shortoff_with_x_given_A_0x00_and_the_value_of_the_address_0x00_expected_0x00(void){
	cpuRegisters->A 	= 0x00;
	set_X(0x12,0x12);
	uint8_t instrc[] 	= {0xE4,0x01};			// 	Opcode : EB41
	memory[0x1213] 		= 0x00;							//	X: 0x1212   offset: 0x01   (X + offset = 0x1213)
...
void test_AND_shortoff_with_y_given_A_0x00_and_the_value_of_the_address_0x00_expected_0x00(void){
	cpuRegisters->A 	= 0x00;
	set_Y(0x23,0x23);
	uint8_t instrc[] 	= {0x90,0xE4,0x22};		// 	Opcode : 90E422
	memory[0x2345] 		= 0x00; 							//	Y: 0x2323   offset: 0x22   (Y + offset = 0x2345)
...
void test_AND_longoff_with_X_given_A_0x00_and_the_value_of_the_address_0x00_expected_0x00(void){
	cpuRegisters->A 	= 0x00;
	set_X(0x34,0x34);
	uint8_t instrc[] 	= {0xD4,0x10,0x10};
	memory[0x4444]		=	0x00;
...
void test_AND_longoff_with_Y_given_A_0x00_and_the_value_of_the_address_0x00_expected_0x00(void){
	cpuRegisters->A 	= 0x00;
	set_Y(0x34,0x34);
	uint8_t instrc[] 	= {0x90,0xD4,0x29,0x29};
	memory[0x5d5d]		=	0x00;
...
void test_AND_shortoff_SP_given_A_0x00_and_the_value_of_the_SP_0x00_expected_0x00(void){
	cpuRegisters->A		= 0x00;
	set_SP(0x88,0x88);
	uint8_t instrc[]	= {0x14,0x22};
	memory[0x88AA]		=	0x00;
...
void test_AND_shortptr_w_given_A_0x00_and_the_value_of_the_address_0x00_expected_0x00(void){
	cpuRegisters->A		= 0x00;
	uint8_t instrc[]	= {0x92,0xc4,0x40};
	memory[0x40]			= 0x42;
	memory[0x41]			= 0xe5;
...
void test_AND_longptr_w_given_A_0x00_and_the_value_of_the_address_0x00_expected_0x00(void){
	cpuRegisters->A		= 0x00;
	uint8_t instrc[]	= {0x72,0xd4,0x10,0x40};
	memory[0x1040]		= 0x42;
	memory[0x1041]		= 0xe5;
...
void test_AND_longptr_w_X_given_A_0x00_and_the_value_of_the_address_0x00_expected_0x00(void){
	cpuRegisters->A 	= 0x00;
	set_X(0x01,0x03);
	uint8_t instrc[]	= {0x72,0xD4,0x10,0x89};
	memory[0x1089]		= 0x18;
...
void test_AND_shortptr_w_Y_given_A_0x00_and_the_value_of_the_address_0x0_expected_0x00(void){
	cpuRegisters->A 	= 0x00;
	set_Y(0x11,0x11);
	uint8_t instrc[]	= {0x91,0xD4,0x89};
	memory[0x89]			= 0x18;
